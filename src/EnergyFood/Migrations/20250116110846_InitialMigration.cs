...
namespace EnergyFood.Migrations
{
    /// <inheritdoc />
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LactationPeriod", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Norm_LactationPeriod_LactationPeriodId",
                        column: x => x.LactationPeriodId,
                        principalSchema: "public",
                        principalTable: "LactationPeriod",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Cow_LactationPeriod_LactationPeriodId",
                        column: x => x.LactationPeriodId,
                        principalSchema: "public",
                        principalTable: "LactationPeriod",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RationFeedType_FeedTypes_FeedTypeId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RationFeedType_Rations_RationId",
                        column: x => x.RationId,
                        principalSchema: "public",
