...
namespace ImportRation.Data;

public class BasalRationDBContext : DbContext
{
    public BasalRationDBContext(DbContextOptions<BasalRationDBContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Ration>().HasData(
            new Ration { Id = 1, Name = "Ration A", LivestockPropertyId = 1},
            new Ration { Id = 2, Name = "Ration B", LivestockPropertyId = 2}
        );
        modelBuilder
